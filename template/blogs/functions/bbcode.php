...
//		$text  = htmlspecialchars($text, ENT_QUOTES,$charset);
        ...
        $text = preg_replace("#\:[0-9a-z]+]#Usi", "]", $text);
...
//		return bbcode::nl2br($text);
    ...
    public static function removebbcode($var){


//        [url=http&#58;//csgolounge&#46;com/:cx2r932y]csgolounge.com[/url:cx2r932y]
        $result = preg_replace("#\:[0-9a-z]+]#Usi", "]", $var);
        $result = preg_replace("#\:[0-9a-z]+]#Usi", "]", $result);

        $result = preg_replace("#\[size.*size]#Usi","", $result);
        $result = preg_replace("#\[glow.*glow]#Usi","", $result);

        $result = preg_replace("#\[/?url(=.*)?]#Usi","", $result);
        $result = preg_replace("#\</?a(.*=.*)*?>#Usi","", $result);



//        $result = preg_replace("#\[/?list(=.*)?]#Usi","", $result);
//        $result = preg_replace("#\[/?*]#Usi", "", $result);
